...
class AdaptadorAuto(private val listaAutos: List<Autoc>) : RecyclerView.Adapter<AdaptadorAuto.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        val auto = listaAutos[position]
        holder.nombre.text = auto.nombre
        holder.fecha.text = auto.nombreModelo
        holder.anio.text = auto.anio.toString()
        holder.auto = auto
        holder.detalles.setOnClickListener{
            v: View ->
            val intent = Intent(v.context, DetalleAutoActivity::class.java)
